...
import { initialize, submit, SubmissionError, stopAsyncValidation, stopSubmit } from "redux-form";
...
class Index extends Component {
  ...
  validateAndGenerate(formValues) {
    ...
    return postDataForValidationOld(obj)
